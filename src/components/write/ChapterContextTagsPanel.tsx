...
export default function ChapterContextTagsPanel({ chapterId, projectId }: Props) {
  ...
  return (
    <div className="p-3">
      <div className="flex items-center justify-between mb-2">
        <span className="text-xs font-medium text-slate-700">Chapter Context Tags</span>
        <button
      ...
      <p className="text-xs text-slate-400 mb-2">
        Tags here apply to all scenes in this chapter (unless a scene has its own tags).
      </p>
      ...
      {tags.length === 0 && !expanded && (
        <p className="text-xs text-slate-400 italic">
          No chapter-level tags. All world data will be sent to the AI.
        </p>
      )}
