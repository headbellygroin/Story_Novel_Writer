...
export default function Settings() {
  ...
  async function initializeDefaultPresets() {
    ...
    const defaults: ModelPreset[] = [
      { task_mode: 'design_brief', label: 'Midnight Miqu Planner', model_name: 'midnight-miqu-70b-v1.5', api_endpoint: endpoint, context_length: 32400, max_tokens: 2000, temperature: 0.70, top_p: 0.92, top_k: 0, repetition_penalty: 1.05, presence_penalty: 0, frequency_penalty: 0, notes: 'Story planning and chapter brief generation. Optimized for narrative architecture with fast throughput.', is_active: true },
      ...
      { task_mode: 'outline', label: 'Midnight Miqu Outline', model_name: 'midnight-miqu-70b-v1.5', api_endpoint: endpoint, context_length: 32400, max_tokens: 2000, temperature: 0.65, top_p: 0.92, top_k: 0, repetition_penalty: 1.05, presence_penalty: 0, frequency_penalty: 0, notes: 'Chapter-by-chapter outline generation. Fast structural planning with narrative awareness.', is_active: true },
      ...
      { task_mode: 'rewrite', label: 'Midnight Miqu Editor', model_name: 'midnight-miqu-70b-v1.5', api_endpoint: endpoint, context_length: 32400, max_tokens: 3000, temperature: 0.70, top_p: 0.92, top_k: 0, repetition_penalty: 1.08, presence_penalty: 0, frequency_penalty: 0, notes: 'Used for quality improvement, emotional depth, dialogue cleanup, pacing improvements, and final prose polish.', is_active: true },
      { task_mode: 'deep_analysis', label: 'Meta Llama Deep Analysis', model_name: 'meta-llama', api_endpoint: endpoint, context_length: 128000, max_tokens: 1500, temperature: 0.40, top_p: 0.9, top_k: 0, repetition_penalty: 1.05, presence_penalty: 0, frequency_penalty: 0, notes: 'Large-context analytical model. Used for whole-book analysis, continuity audits, lore consistency checks, and multi-chapter review. Slow but thorough.', is_active: true },
